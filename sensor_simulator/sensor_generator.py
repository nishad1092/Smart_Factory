...
with open(file_path, 'r') as file:
    openplc_config = yaml.safe_load(file)
print(openplc_config)
...
PLC_IP = openplc_config['OPENPLC_IP']   # IP of your Debian 13 VM
PLC_PORT = openplc_config['OPENPLC_PORT']        # Modbus port you configured
